...
export function WeatherWidget(props: Props) {
  const {
    forecast: { temperature, high, low, location, icon, weather },
  } = props;
        ...
        >
          <Path path={path}>
            <LinearGradient
              ...
              end={vec(widgetWidth, widgetHeight)}
...
/*
<svg width="340" height="167" viewBox="0 0 340 167" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1.13802 66.5329C0.149349 32.5295 -0.344987 15.5278 10.4273 6.20755C21.1996 -3.11274 37.9536 -0.179038 71.4615 5.68837L301.126 45.9037C317.815 48.826 326.159 50.2872 331.268 56.104C336.377 61.9208 336.75 70.384 337.494 87.3105L338.979 121.066C339.928 142.636 340.403 153.421 333.905 160.211C327.408 167 316.613 167 295.022 167H46.7985C26.6014 167 16.5028 167 10.1002 160.781C3.69752 154.562 3.40402 144.467 2.81702 124.279L1.13802 66.5329Z" fill="url(#paint0_linear_37_1051)"/>
<defs>
<linearGradient id="paint0_linear_37_1051" x1="-1" y1="120" x2="353.142" y2="120" gradientUnits="userSpaceOnUse">
